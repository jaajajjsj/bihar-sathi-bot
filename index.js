...
const fs = require('fs');
const qrcode = require('qrcode-terminal'); // ✅ QR Lib Added
...
// ═════════════════════════════════════════════
const SERVICES = {
    '1': { key: 'AADHAAR', title: 'आधार कार्ड सुधार', menu: `🆔 *आधार कार्ड सेवा*\n──────────────────\n1️⃣ पता अपडेट (Address Update)\n2️⃣ नाम/जन्म तिथि (Name/DOB)\n3️⃣ डॉक्यूमेंट अपडेट (Doc Update)\n0️⃣ Go Back`, req: ["🔹 पुराना आधार कार्ड", "🔹 आवासी", "🔹आधार से जुड़ा हुआ मोबाइल नंबर "], note: "\n⚠️ *Note:* OTP के लिए तैयार रहें।" },
    '2': { key: 'PAN', title: 'पैन कार्ड अप्लाई', menu: `💳 *पैन कार्ड सेवा*\n──────────────────\n1️⃣ नया पैन कार्ड (New Apply)\n2️⃣ पैन सुधार (Correction)\n3️⃣ पैन-आधार लिंक (Link)\n0️⃣ Go Back`, req: ["🔹 आधार कार्ड (दोनों साइड)", "🔹 2 पासपोर्ट साइज फोटो", "🔹 सादा कागज पर Sign", "🔹 मोबाइल नंबर"] },
    '3': { key: 'CERT', title: 'RTPS (आय/जाति/निवास)', menu: `📜 *बिहार RTPS सेवा*\n──────────────────\n1️⃣ आय प्रमाण पत्र (Income)\n2️⃣ जाति प्रमाण पत्र (Caste)\n3️⃣ आवासीय प्रमाण पत्र (Residence)\n0️⃣ Go Back`, req: ["🔹 आधार कार्ड (दोनों साइड)", "🔹 एक फोटो", "🔹 मोबाइल नंबर","🔹 सादा कागज पर Sign", "🔹 जाती के लिए-- पुराना जाती डाले, घर में किसी का, नहीं तो कॉल करे) "] },
    '4': { key: 'RATION', title: 'राशन कार्ड (Bihar)', menu: `🍚 *बिहार राशन कार्ड*\n──────────────────\n1️⃣ नया राशन कार्ड (New Card)\n2️⃣ नाम जोड़ें (Add Member)\n3️⃣ नाम हटाए (Delete Member)\n0️⃣ Go Back`, req: ["🔹 मुखिया (महिला) का आधार", "🔹 बैंक पासबुक", "🔹 आय, जाति, निवास", "🔹 पूरे परिवार का फोटो", "🔹 सभी का आधार", "🔹 सादा कागज पर Sign"] },
    '8': { key: 'PENSION', title: 'वृद्धा पेंशन (Pension)', menu: `👵 *वृद्धा पेंशन सेवा*\n──────────────────\n1️⃣ नया आवेदन (New Apply)\n0️⃣ Go Back`, req: ["🔹 आधार कार्ड", "🔹 पहचान पत्र (Voter ID)", "🔹 बैंक पासबुक", "🔹 फोटो", "🔹 हस्ताक्षर (Sign)"] },
    '9': { key: 'ESHRAM', title: 'ई-श्रम कार्ड (e-Shram)', menu: `👷 *ई-श्रम कार्ड सेवा*\n──────────────────\n1️⃣ नया कार्ड (New Apply)\n2️⃣ अपडेट/डाउनलोड\n0️⃣ Go Back`, req: ["🔹 आधार कार्ड", "🔹 बैंक पासबुक", "🔹 मोबाइल नंबर"] }
};

// ═════════════════════════════════════════════
// 🔌 CONNECT WITH MANUAL QR
// ═════════════════════════════════════════════
async function connectToWhatsApp() {
    const { state, saveCreds } = await useMultiFileAuthState('auth_info_baileys');
    const { version } = await fetchLatestBaileysVersion();

    console.log("⏳ QR Code setup हो रहा है...");

    const sock = makeWASocket({
        version,
        auth: state,
        // printQRInTerminal: false, // ❌ REMOVED to fix warning
        logger: pino({ level: 'silent' }),
        browser: ['Bihar Sathi', 'Chrome', '10.0.0'],
    ...
    sock.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            if (reason === DisconnectReason.badSession || reason === DisconnectReason.loggedOut) {
                console.log("❌ Session Failed. Restarting...");
